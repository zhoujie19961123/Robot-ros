...
disp(' ')
disp('bdb2=sisobnds(2,w,wbd2,W2,P); %output dist. rejection')
drawnow
wbd2=wbd1;
W2=0.1;
...
disp(' ')
disp('chksiso(2,wl,W2,P,[],G); %output dist. rejection spec')
drawnow
w1=75*2*pi;w2=225*2*pi;
ind=find(wl<=w2 & wl>=w1);
chksiso(2,wl(ind),W2,P(ind),[],G(ind));
qpause;close(gcf);
