...
%   clcp      - Closed-loop of frequency response sets.
%   clnd      - Closed-loop of transfer function num/den sets.
%   mulcp     - Multiplication of frequency response sets.
%   mulnd     - Multiplication of transfer function num/den sets.
%
% General Utility.
...
%qnicvuw  - axis limits manipulator for LPSHAPE/DLPSHAPE
%qmagvuw  - axis limits manipulator for PFSHAPE/DPFSHAPE
...
%lpshpdef  - defaults for LPSHAPE/DLPSHAPE
%pfshpdef  - defaults for PFSHAPE/DPFSHAPE
...
%           computation
%qclswin  - reset interface within LPSHAPE/DLPSHAPE/PFSHAPE/DPFSHAPE
