...
d1=2;d2=3;d3=6;
u1=-(d1+d2*norm([e(1),e(2)])+d3*norm([de(1),de(2)]))*sign(y(1));
...
R=FAI*P;
tol(1)=-(Kp1(1,1)+Kp2(1,1)/(alfa1+abs(e(1))))*e(1)-(Kv1(1,1)+Kv2(1,1)/(beta1+abs(de(1))))*de(1)+R(1)+u1;
tol(2)=-(Kp1(2,2)+Kp2(2,2)/(alfa2+abs(e(2))))*e(2)-(Kv1(2,2)+Kv2(2,2)/(beta2+abs(de(2))))*de(2)+R(2)+u2;
