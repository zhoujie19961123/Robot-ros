...
// (in-package learning_commuication.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'learning_commuication/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'learning_commuication/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'learning_commuication/AddTwoInts'; }
};
